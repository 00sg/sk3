...
import { FormatColorTextSharp, MoreHorizOutlined, ShareOutlined } from "@material-ui/icons";
  ...
  return (
    ...
    >
      ...
      <div className="post__footer">
        ...
        <IconButton aria-label="upvotebtn" className="upvotebtn">
        <ArrowUpwardOutlinedIcon/>
</IconButton>

<IconButton aria-label="downvotebtn" className="downvotebtn" >
